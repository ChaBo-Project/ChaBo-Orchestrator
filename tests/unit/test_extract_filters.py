...
# committed to source). This test needs valid values for its own crop-domain cases
# regardless of what INSTANCE_CONFIG_DIR happens to be set to when it's run.
